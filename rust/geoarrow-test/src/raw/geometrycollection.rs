...
pub mod xy {
    ...
    pub fn geoms() -> Vec<Option<wkt::types::GeometryCollection<f64>>> {
        vec![
            Some(wkt! { GEOMETRYCOLLECTION (POINT (30. 10.)) }),
            Some(wkt! { GEOMETRYCOLLECTION (LINESTRING (30. 10., 10. 30., 40. 40.)) }),
            Some(
                wkt! { GEOMETRYCOLLECTION (POLYGON ((30. 10., 40. 40., 20. 40., 10. 20., 30. 10.))) },
            ),
...
pub mod xyz {
    ...
    pub fn geoms() -> Vec<Option<wkt::types::GeometryCollection<f64>>> {
        vec![
            ...
            Some(
                wkt! { GEOMETRYCOLLECTION Z (LINESTRING Z (30. 10. 40., 10. 30. 40., 40. 40. 80.)) },
            ),
            Some(
...
pub mod xym {
    ...
    pub fn geoms() -> Vec<Option<wkt::types::GeometryCollection<f64>>> {
        vec![
            ...
            Some(
                wkt! { GEOMETRYCOLLECTION M (LINESTRING M (30. 10. 300., 10. 30. 300., 40. 40. 1600.)) },
            ),
            Some(
