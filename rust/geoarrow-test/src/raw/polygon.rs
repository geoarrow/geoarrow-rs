...
pub mod xy {
    ...
    pub fn geoms() -> Vec<Option<wkt::types::Polygon<f64>>> {
        vec![
...
pub mod xyz {
    ...
    pub fn geoms() -> Vec<Option<wkt::types::Polygon<f64>>> {
        vec![
            Some(
                wkt! { POLYGON Z ((30. 10. 40., 40. 40. 80., 20. 40. 60., 10. 20. 30., 30. 10. 40.)) },
            ),
            Some(
...
pub mod xym {
    ...
    pub fn geoms() -> Vec<Option<wkt::types::Polygon<f64>>> {
        vec![
            Some(
                wkt! { POLYGON M ((30. 10. 300., 40. 40. 1600., 20. 40. 800., 10. 20. 200., 30. 10. 300.)) },
            ),
            Some(
