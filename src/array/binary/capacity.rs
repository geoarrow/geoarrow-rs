...
impl WKBCapacity {
    ...
    #[inline]
    pub fn add_line_string<'a>(&mut self, line_string: Option<&'a (impl LineStringTrait<2> + 'a)>) {
    ...
    #[inline]
    pub fn add_multi_point<'a>(&mut self, multi_point: Option<&'a (impl MultiPointTrait<2> + 'a)>) {
    ...
    pub fn add_multi_line_string<'a>(
        &mut self,
        multi_line_string: Option<&'a (impl MultiLineStringTrait<2> + 'a)>,
    ) {
    ...
    #[inline]
    pub fn add_geometry<'a>(&mut self, geom: Option<&'a (impl GeometryTrait<2> + 'a)>) {
    ...
    pub fn add_geometry_collection<'a>(
        &mut self,
        geometry_collection: Option<&'a (impl GeometryCollectionTrait<2> + 'a)>,
    ) {
