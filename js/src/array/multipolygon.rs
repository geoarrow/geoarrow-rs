...
impl MultiPolygonArray {
    ...
    pub fn center(&self) -> WasmResult<PointArray> {
        ...
        let out = center(&GeometryArray::MultiPolygon(self.0.clone()))?;
        Ok(PointArray(out))
    }
    ...
    pub fn centroid(&self) -> WasmResult<PointArray> {
        ...
        let out = centroid(&GeometryArray::MultiPolygon(self.0.clone()))?;
        Ok(PointArray(out))
    }
    ...
    pub fn convex_hull(&self) -> WasmResult<PolygonArray> {
        ...
        let out = convex_hull(&GeometryArray::MultiPolygon(self.0.clone()))?;
        Ok(PolygonArray(out))
    }
    ...
    pub fn signed_area(&self) -> WasmResult<Float64Array> {
        ...
        let out = signed_area(GeometryArray::MultiPolygon(self.0.clone()))?;
        Ok(Float64Array(out))
    }
}
