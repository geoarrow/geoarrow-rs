...
For interoperability with [Shapely](https://shapely.readthedocs.io/en/stable/index.html), use the top-level [`to_shapely`][geoarrow.rust.core.to_shapely] and [`from_shapely`][geoarrow.rust.core.from_shapely] functions.
